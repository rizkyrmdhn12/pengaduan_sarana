...
<head>
    ...
    <title><?php echo $__env->yieldContent('title','Pengaduan Sarana'); ?> - SMK Sangkuriang 1</title>
    ...
    <div class="container-fluid">
        ...
        <div class="ms-auto d-flex align-items-center gap-2">
            <?php if(session('role') === 'admin'): ?>
                <span class="role-badge role-<?php echo e(session('admin_role')); ?>">
                    <?php echo e(session('admin_role_label')); ?>

                </span>
                <span class="text-white small d-none d-md-inline"><?php echo e(session('admin_nama')); ?></span>
            <?php elseif(session('role') === 'siswa'): ?>
                <span class="badge" style="background:var(--smk-kuning);color:#333">
                    <i class="bi bi-mortarboard me-1"></i><?php echo e(session('siswa_nama')); ?>
...
<div class="d-flex">
    ...
    <div class="sidebar" id="sidebar">
        <?php if(session('role') === 'admin'): ?>
            ...
            <?php if(in_array(session('admin_role'), ['kepala_sekolah','guru','sapras','guru_bk'])): ?>
            <a href="/admin/aspirasi?jenis=sarana_prasarana" class="nav-link <?php echo e(request()->is('admin/aspirasi*') && request('jenis') == 'sarana_prasarana' ? 'active' : ''); ?>">
                <i class="bi bi-tools"></i> Sarana &amp; Prasarana
            </a>
            <?php endif; ?>
            <?php if(in_array(session('admin_role'), ['kepala_sekolah','guru','kesiswaan','guru_bk'])): ?>
            <a href="/admin/aspirasi?jenis=kesejahteraan_siswa" class="nav-link <?php echo e(request()->is('admin/aspirasi*') && request('jenis') == 'kesejahteraan_siswa' ? 'active' : ''); ?>">
                <i class="bi bi-heart-pulse"></i> Kesejahteraan Siswa
            </a>
            <?php endif; ?>
            <a href="/admin/aspirasi" class="nav-link <?php echo e(request()->is('admin/aspirasi') && !request('jenis') ? 'active' : ''); ?>">
                <i class="bi bi-inbox"></i> Semua Laporan
            </a>
        <?php else: ?>
            <div class="nav-section">Menu Siswa</div>
            <a href="/siswa/dashboard" class="nav-link <?php echo e(request()->is('siswa/dashboard') ? 'active' : ''); ?>">
                <i class="bi bi-house"></i> Dashboard
            </a>
            <hr class="nav-divider">
            <div class="nav-section">Buat Laporan</div>
            <a href="/siswa/aspirasi" class="nav-link <?php echo e(request()->is('siswa/aspirasi') ? 'active' : ''); ?>">
                <i class="bi bi-megaphone"></i> Buat Aspirasi
            </a>
            <hr class="nav-divider">
            <div class="nav-section">Riwayat</div>
            <a href="/siswa/histori" class="nav-link <?php echo e(request()->is('siswa/histori*') ? 'active' : ''); ?>">
...
<?php /**PATH C:\xampp\htdocs\pengaduan_sarana\resources\views/layouts/app.blade.php ENDPATH**/ ?>