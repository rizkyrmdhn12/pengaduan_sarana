...
<div class="login-wrapper">
    ...
    <div class="login-card">
        ...
        <div class="alert alert-danger rounded-3 py-2 mb-3">
            <i class="bi bi-exclamation-circle me-2"></i><?php echo e($errors->first('login')); ?>
        ...
        <form method="POST" action="/login">
            ...
            <div class="mb-3">
                ...
                <div class="d-flex gap-2 role-tabs">
                    <label>
                        <input type="radio" name="role" value="admin" class="d-none role-radio" <?php echo e(old('role')=='admin' ? 'checked' : ''); ?>>
                        <div class="nav-link <?php echo e(old('role')=='admin' ? 'active' : ''); ?>">
                            <i class="bi bi-person-gear me-1"></i>Guru / Staff
                        </div>
                    </label>
                    <label>
                        <input type="radio" name="role" value="siswa" class="d-none role-radio" <?php echo e(old('role','siswa')=='siswa' ? 'checked' : ''); ?>>
                        <div class="nav-link <?php echo e(old('role','siswa')=='siswa' ? 'active' : ''); ?>">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="username" value="<?php echo e(old('username')); ?>" placeholder="Username / NIS / Nama Siswa" autofocus>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\pengaduan_sarana\resources\views/auth/login.blade.php ENDPATH**/ ?>