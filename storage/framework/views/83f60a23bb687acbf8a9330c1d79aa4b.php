                    ...
                    <form method="POST" action="/siswa/aspirasi" enctype="multipart/form-data" id="formAspirasi">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" value="<?php echo e(session('siswa_nama')); ?>" disabled>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-semibold small">Kelas</label>
                                <input type="text" class="form-control" value="<?php echo e(session('siswa_kelas')); ?>" disabled>
                            </div>
                        </div>
                        ...
                        <div class="mb-3" id="seksiKategori" style="display:none">
                            ...
                            <input type="hidden" name="id_kategori" id="selectedKategori" value="<?php echo e(old('id_kategori')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        {
                            "sarana": <?php echo json_encode($kategoris['sarana_prasarana']); ?>,
                            "kesejahteraan": <?php echo json_encode($kategoris['kesejahteraan_siswa']); ?>
...
unset($__errorArgs, $__bag); ?>"
                                       name="lokasi" value="<?php echo e(old('lokasi')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                    placeholder="Jelaskan secara detail apa yang terjadi..."><?php echo e(old('ket')); ?></textarea>
                                <?php $__errorArgs = ['ket'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="anonim" id="anonimCheck" <?php echo e(old('anonim') ? 'checked' : ''); ?>>
...
function buildKategori(jenis) {
    ...
    grid.innerHTML = '';
    cats.forEach((k, i) => {
        const preselected = '<?php echo e(old("id_kategori")); ?>' == k.id_kategori;
        grid.innerHTML += `
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    ['sarana','kesejahteraan'].forEach(j => {
        const found = dataKategori[j]?.find(k => k.id_kategori == '<?php echo e(old("id_kategori")); ?>');
        if (found) {
            const card = document.querySelector(`.jenis-card[data-jenis="${j}"]`);
            if (card) card.click();
            setTimeout(() => {
                const katCard = document.querySelector(`.kat-card[data-id="<?php echo e(old('id_kategori')); ?>"]`);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\pengaduan_sarana\resources\views/siswa/form_aspirasi.blade.php ENDPATH**/ ?>