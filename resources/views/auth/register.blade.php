    ...
    <div class="reg-card">
        ...
        <form method="POST" action="/register">
            ...
            <div class="mb-3">
                ...
                @error('nis')<div class="text-danger small mt-1"><i class="bi bi-exclamation-circle me-1"></i>{{ $message }}</div>@enderror
            </div>
            ...
            <div class="mb-3">
                ...
                @error('nama_siswa')<div class="text-danger small mt-1"><i class="bi bi-exclamation-circle me-1"></i>{{ $message }}</div>@enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="kelas-grid">
                    ...
                    <div class="kelas-btn {{ old('kelas')==$k ? 'selected' : '' }}" onclick="pilihKelas('{{ $k }}')">{{ $k }}</div>
                    @endforeach
                </div>
                @error('kelas')<div class="text-danger small mt-1"><i class="bi bi-exclamation-circle me-1"></i>{{ $message }}</div>@enderror
            </div>
